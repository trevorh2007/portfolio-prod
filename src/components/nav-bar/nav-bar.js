    ...
    <div className="fixed-nav">
      <nav ref={resumeDropdownRef}>
        ...
        <div className="nav-bar">
          <div className="page-link" onClick={() => scrollIntoView("home")}>
            Home
          </div>
          <div className="page-link" onClick={() => scrollIntoView("projects")}>
            Projects
          </div>
          <div className="page-link" onClick={() => scrollIntoView("contact")}>
            Contact
          </div>
          <div
            className="page-link"
            ...
            <div className="resume-container">
              <div className="resume-dropdown">
                <ul>
                  ...
                  <li
                    onClick={() =>
                      window.open(resumeDOCX, "_blank", "noopener,noreferrer")
                    }
                  >
                    DOCX
                  </li>
        ...
        <div className="mobile-nav-toggle">
          ...
          <div id="mobile-menu">
            <div className="page-link-padding">
              <div
                className="page-link"
                onClick={() => scrollIntoViewMobile("home")}
              >
                <IoHomeOutline />
                Home
              </div>
              <div
                className="page-link"
                onClick={() => scrollIntoViewMobile("projects")}
              >
                <IoHammerOutline />
                Projects
              </div>
              <div
                className="page-link"
                onClick={() => scrollIntoViewMobile("contact")}
              >
                <IoMailOutline />
                Contact
              </div>
              ...
              {resumeDropdownOpen && (
                <div className="resume-container">
                  <div className="resume-dropdown">
                    <ul>
                      <li onClick={() => window.open(resumePDF, "_blank")}>
                        PDF
                      </li>
                      <li
                        onClick={() =>
