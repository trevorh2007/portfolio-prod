        ...
        <div className="project-gallery">
          <div className="project-cards">
            <div
              ...
              onClick={() => {
                modal.current.open();
                document.getElementsByClassName("fixed-nav")[0].className +=
                  " hidden-nav";
            ...
            >
              ...
              <div className={modalHover1}>
                <div className="hover-title">Discord Bot</div>
              </div>
            </div>
            <ProjectModal ref={modal} fade>
              <img src={discordGif} className="project-gif" alt="Discord bot" />
              <div className="project-description">
                A commissioned Discord bot with fun and managerial commands for
                Saints Hall clan, playing Old School Runescape.
                <ul>
              ...
              <div className="project-btns">
                <div
                  className="project-link-btn btn"
                  onClick={() =>
                    window.open("https://www.saintshall.com", "_blank")
                  }
                >
                  View Site
                </div>
                <div
                  className="project-source-btn btn"
                  onClick={() =>
                    window.open(
                      "https://replit.com/@RelliKBooN/SaintsHallDiscordBot",
                      "_blank"
                    )
                  }
                >
                ...
                <div
                  className="discord-btn btn"
                  onClick={() =>
                    window.open("https://discord.gg/UuAtKjcgk5", "_blank")
                  }
                >
                  Play on Discord!
                  <span>(requires discord login)</span>
                </div>
              </div>
            </ProjectModal>
            <div
            ...
            >
              <img
                ...
                className="width-50-img"
                alt="Kanban Board"
              />
              <div className={modalHover2}>
                <div className="hover-title">Kanban Board</div>
              </div>
            </div>
            <ProjectModal ref={modal2} fade>
              <img
                src={kanbanGif}
                className="project-gif short-height-gif"
                alt="Kanban Board"
              />
              <div className="project-description">
                Drag and drop kanban board I wanted to create for personal use.
                If you demo the site you can see I was actually using it as I
                was building it. This was a ton of fun to build and I will be
                using and upgrading this application throughout my development
                career.
                <ul>
                  <li>
                    PostgreSQL for storage needs (Micro-service RESTful API
                    hosted on Heroku)
                  </li>
              ...
              <div className="project-btns">
                <div
                  ...
                  onClick={() =>
                    window.open(
                      "https://kanban-clone.rellikboon.repl.co/",
                      "_blank"
                    )
                  }
                >
                ...
                <div
                  ...
                  onClick={() =>
                    window.open(
                      "https://github.com/trevorh2007/kanban-clone",
                      "_blank"
                    )
                  }
                >
            ...
            >
              ...
              <div className={modalHover3}>
                <div className="hover-title">Narcolepsy Link</div>
              </div>
            </div>
            <ProjectModal ref={modal3} fade>
              ...
              />
              <div className="project-description">
                A website built for healthcare professionals to stay informed
                about narcolepsy. ESS/SNS screeners to help determine if their
                patients may have narcolepsy with or without cataplexy.
                <ul>
              ...
              <div className="project-btns">
                <div
                  className="project-link-btn btn"
                  onClick={() =>
                    window.open("https://www.narcolepsylink.com", "_blank")
                  }
                >
                  View Site
                </div>
            ...
            >
              ...
              <div className={modalHover4}>
                <div className="hover-title">Xyrem</div>
              </div>
            </div>
            <ProjectModal ref={modal4} fade>
              <img src={xyremGif} className="project-gif" alt="Xyrem" />
              <div className="project-description">
                A healthcare based website for the pharmaceutical drug Xyrem.
                Information for obtaining, taking, and any questions patients or
                professionals may have about the drug Xyrem.
                <ul>
                  <li>MySQL for storage needs</li>
              ...
              <div className="project-btns">
                <div
                  className="project-link-btn btn"
                  onClick={() => window.open("https://www.xyrem.com", "_blank")}
                >
                  View Site
                  <span>(disable adblock to view site)</span>
                </div>
              </div>
            </ProjectModal>
          </div>
